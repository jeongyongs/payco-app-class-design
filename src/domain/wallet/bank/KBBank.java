...
public class KBBank extends Bank {              // 국민 은행
    public KBBank(String number, String pw) {   // 생성자
        super(number, pw);
    }
    ...
    protected boolean callAPI() {   // 은행 API 호출
        System.out.println("국민은행에 유효성 검사를 요청합니다.");
        System.out.println("국민은행에 거래를 요청합니다.");
        return true;
    }
