...
public class KBCard extends Card {      // 국민 카드
    public KBCard(String number, String pw, String vaildDate, String cvc) {     // 생성자
    ...
    protected boolean callAPI() {       // 카드사 API 호출
        System.out.println("국민카드에 유효성 검사를 요청합니다.");
        System.out.println("국민카드에 거래를 요청합니다.");
        return true;
    }
